...
<style>
/* #ppp{width:947px;margin:0 auto;font-size:20px;font-family:"微软雅黑";font-weight:900} */
/* #hot4{float:left;border:5px solid white} */
/* #digest{font-size:18px;font-family:微软雅黑;color:black} */
#li {
...
<body>
	<!-- <p id="ppp"><%--int visit = (int)application.getAttribute("count");--%>
	访问数：<%--= visit --%></p> -->
